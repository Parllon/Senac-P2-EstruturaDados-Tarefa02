...
for i in range(8, -4, -2):
    ...
    if elemento:
        print("Elemento {0} prensete na lista".format(i))
    else:
        print("Elemento {0} não encontrato".format(i))
"""
"""
######INSERE DEPOIS######
lista = ListaEncadeada()
...
print("Inserido um único elemento depois de um outro:", lista)
"""
""" 
#####INSERE NO INICIO#####
...
print("Inserido um único elemento:", lista)
"""
